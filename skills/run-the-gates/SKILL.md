...
The gate is six hardware-free suites. It is the only thing that counts as proof
...
bash tests/run-all.sh --list   # plugin-validate manifest.test.sh model.test.mjs ctl.test.sh keybindings.test.sh qml-lint.sh
```
